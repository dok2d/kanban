...
[English version](README.md) | [Документация](docs/README.md)
...
- Спринты со статусами планирование/активный/завершён и представлением бэклога
- Фильтрация доски по спринту и эпику в шапке (⬡ kanban / Спринт / Эпик)
- Завершение спринта с автоматическим переносом задач в следующий спринт
...
Восстановление пароля доступно для пользователей с привязанным Telegram — 8-значный код отправляется в бот.
...
| Метод  | Путь                | Описание                                      |
|--------|---------------------|-----------------------------------------------|
| GET    | /api/board          | Вся доска (колонки, задачи, эпики, спринты, теги) |
...
| POST   | /api/sprints/:id/complete   | Завершить спринт (перенос задач)       |
